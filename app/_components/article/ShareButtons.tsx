...
export default function ShareButtons({ url, title, copyLabel, copiedLabel, shareLabel }: Props) {
  ...
  return (
    <div className={styles.actions}>
      ...
      <button className={styles.btn} onClick={shareFacebook} aria-label="Share on Facebook">
        <svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">

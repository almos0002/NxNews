...
export const metadata: Metadata = {
  ...
  description: "Join KumariHub for unlimited access to independent journalism.",
};
        ...
        <div className={styles.panel}>
          ...
          <div className={styles.brandSide}>
            <div className={styles.brandTop}>
              <a href="/" className={styles.brandLogo}>
                <Image src="/logo.png" alt="KumariHub" width={130} height={42} style={{ objectFit: "contain" }} />
              </a>
              <p className={styles.brandTagline}>
                Join thousands of<br />readers across<br /><span>Nepal and the world.</span>
              </p>
              <div className={styles.brandPerks}>
                {perks.map((p) => (
                  <div key={p} className={styles.brandPerk}>
                    <svg className={styles.perkCheck} width="14" height="14" viewBox="0 0 14 14" fill="none">
          ...
          <div className={styles.formSide}>
            <div className={styles.formHeader}>
              <h1 className={styles.heading}>Join KumariHub</h1>
              <p className={styles.subheading}>Create your free account</p>
            </div>
            ...
            <form className={styles.form} action="#">
              <div className={styles.nameRow}>
                <div className={styles.field}>
                  ...
                  <input id="firstName" type="text" name="firstName" autoComplete="given-name"
                    placeholder="Jane" className={styles.input} required />
                </div>
                <div className={styles.field}>
                  <label htmlFor="lastName" className={styles.label}>Last name</label>
                  <input id="lastName" type="text" name="lastName" autoComplete="family-name"
                    placeholder="Smith" className={styles.input} required />
                </div>
              </div>
              ...
              <div className={styles.field}>
                ...
                <input id="password" type="password" name="password" autoComplete="new-password"
                  placeholder="Create a password (min. 8 chars)" className={styles.input} required minLength={8} />
              </div>

              <div className={styles.field}>
                <label htmlFor="confirmPassword" className={styles.label}>Confirm password</label>
                <input id="confirmPassword" type="password" name="confirmPassword" autoComplete="new-password"
                  placeholder="Repeat your password" className={styles.input} required />
              </div>
              ...
              <label className={styles.checkboxLabel}>
                ...
                <span>
                  I agree to the <a href="/terms" className={styles.inlineLink}>Terms of Service</a> and <a href="/privacy" className={styles.inlineLink}>Privacy Policy</a>
                </span>
              </label>

...
export const metadata: Metadata = {
  title: "Create Account — The Daily Report",
  description: "Create a free account to unlock full access to The Daily Report's independent journalism.",
};
      ...
      <main className={styles.main}>
        <div className={styles.card}>
          ...
          <div className={styles.cardHeader}>
            ...
            <p className={styles.subheading}>Free access to independent journalism — no card required</p>
          </div>
              ...
              <div key={perk} className={styles.perk}>
                <span className={styles.perkIcon} aria-hidden="true">
                  <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
                    <circle cx="7" cy="7" r="7" fill="#e63946" opacity="0.12" />
                    <path d="M4 7l2 2 4-4" stroke="#e63946" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                  </svg>
                </span>
                <span>{perk}</span>
              </div>
          ...
          <form className={styles.form} action="#">
            ...
            <label className={styles.checkboxLabel}>
              ...
              <span>Send me the Morning Briefing newsletter</span>
            </label>
            ...
            <label className={styles.checkboxLabel}>
              ...
              <span>
                I agree to the{" "}
                <a href="/terms" className={styles.inlineLink}>Terms of Service</a>
                {" "}and{" "}
                <a href="/privacy" className={styles.inlineLink}>Privacy Policy</a>
              </span>
            </label>

            <button type="submit" className={styles.submitBtn}>Create free account</button>
          </form>

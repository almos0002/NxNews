      ...
      <main className={styles.main}>
        <div className={styles.card}>
          ...
          <div className={styles.perks}>
            {["Unlimited article access", "Morning Briefing newsletter", "Personalised reading list", "Ad-light reading experience"].map((perk) => (
          ...
          <form className={styles.form} action="#">
            ...
            <div className={styles.field}>
              ...
              <input id="password" type="password" name="password" autoComplete="new-password"
                placeholder={t("passwordPlaceholder")} className={styles.input} required minLength={8} />
            </div>
            ...
            <div className={styles.field}>
              ...
              <input id="confirmPassword" type="password" name="confirmPassword" autoComplete="new-password"
                placeholder={t("confirmPlaceholder")} className={styles.input} required />
            </div>

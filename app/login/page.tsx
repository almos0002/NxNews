...
export const metadata: Metadata = {
  title: "Sign In — The Daily Report",
  description: "Sign in to your Daily Report account for full access to independent journalism.",
};
      ...
      <main className={styles.main}>
        <div className={styles.card}>
          ...
          <div className={styles.cardHeader}>
            ...
            <p className={styles.subheading}>Sign in to your Daily Report account</p>
          </div>
          ...
          <p className={styles.footer}>
            ...
            <a href="/signup" className={styles.footerLink}>Create one free</a>
          </p>
